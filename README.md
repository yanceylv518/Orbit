...
3. **LIVE-SMALL 小资金实盘**：与原始 TB4 paper 前向并行的 500 USDT 自动执行；V3 固定使用 TB4 目标的 3 倍、12 市场逐仓 3x（冻结清单唯一指令源、逐单映射验证、哈希链账本、回撤停止新增订单、急停不对称），协议见 `docs/design/LIVE_SMALL.md`。
